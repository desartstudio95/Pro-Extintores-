...
const updatedContent = content.replace(/const allProducts = \{[\s\S]*?\};\n\nexport default function ProductPage\(\)/, `const allProducts = {
  'extintores': {
    name: 'Extintores',
...
fs.writeFileSync('src/pages/ProductPage.tsx', updatedContent);
