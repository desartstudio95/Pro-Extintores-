    ...
    <section id="about" className="relative z-10 scroll-mt-24 pt-10">
      <div className="max-w-7xl mx-auto px-6">
        <motion.div 
          ...
          className="glass-panel p-8 md:p-14 lg:p-20 rounded-[2rem] md:rounded-[2.5rem] border border-white/10 relative overflow-hidden"
        >
            ...
            <div className="grid gap-6">
              ...
              >
                <div className="flex items-center gap-4 mb-3">
                  ...
                  <h4 className="text-xl font-bold text-white tracking-tight">Missão</h4>
                </div>
              ...
              >
                <div className="flex items-center gap-4 mb-3">
                  ...
                  <h4 className="text-xl font-bold text-white tracking-tight">Visão</h4>
                </div>
                <p className="text-gray-400 text-sm font-light leading-relaxed">
              ...
              >
                <div className="flex items-center gap-4 mb-3">
                  ...
                  <h4 className="text-xl font-bold text-white tracking-tight">Valores</h4>
                </div>
                <p className="text-gray-400 text-sm font-light leading-relaxed">
