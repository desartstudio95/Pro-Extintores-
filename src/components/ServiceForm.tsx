          ...
          <form className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input id="sf-instalacao" type="text" className="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-pro-red/20 focus:border-pro-red transition-all text-sm" placeholder="Ex: Escritório" />
              </div>
              <div>
                <label className="block text-xs font-bold text-gray-700 mb-1.5">2. Serviço necessário</label>
                <input id="sf-servico" type="text" className="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-pro-red/20 focus:border-pro-red transition-all text-sm" placeholder="Ex: Extintores" />
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input id="sf-localizacao" type="text" className="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-pro-red/20 focus:border-pro-red transition-all text-sm" placeholder="Ex: Maputo" />
              </div>
              <div>
                <label className="block text-xs font-bold text-gray-700 mb-1.5">4. Telefone</label>
                <input id="sf-telefone" type="tel" className="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-pro-red/20 focus:border-pro-red transition-all text-sm" placeholder="+258 8..." />
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input id="sf-nome" type="text" className="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-pro-red/20 focus:border-pro-red transition-all text-sm" placeholder="Seu nome" />
              </div>
              <div>
                <label className="block text-xs font-bold text-gray-700 mb-1.5">6. Empresa</label>
                <input id="sf-empresa" type="text" className="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-pro-red/20 focus:border-pro-red transition-all text-sm" placeholder="Sua empresa" />
              </div>
            </div>

            <div>
              <label className="block text-xs font-bold text-gray-700 mb-1.5">7. Mensagem</label>
              <textarea id="sf-mensagem" rows={3} className="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-pro-red/20 focus:border-pro-red transition-all text-sm resize-none" placeholder="Detalhes adicionais..."></textarea>
            </div>
