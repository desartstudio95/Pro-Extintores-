    ...
    <section className="relative z-10">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center max-w-3xl mx-auto mb-14 lg:mb-16">
          ...
          <h3 className="text-3xl md:text-4xl font-bold font-heading text-gray-900 tracking-tight leading-[1.1]">
        ...
        <div className="grid md:grid-cols-3 gap-5 lg:gap-6">
          {testimonials.map((t, index) => (
            <motion.div
              ...
              key={index}
              className="bg-white border border-gray-100 shadow-sm p-6 md:p-8 rounded-[1.5rem] relative group hover:-translate-y-2 transition-transform duration-500 flex flex-col items-start"
            >
              <div className="absolute top-8 right-8 text-gray-900/5 group-hover:text-pro-red/10 transition-colors duration-500">
              ...
              <p className="text-gray-600 mb-8 italic relative z-10 leading-relaxed font-light text-[15px]">
                "{t.text}"
              </p>
              
              <div className="relative z-10 mt-auto flex items-center gap-3">
                <div className="w-10 h-10 bg-gray-100 rounded-full border border-gray-300 flex items-center justify-center font-bold text-gray-900 text-sm">
                  {t.author.charAt(0)}
                </div>
                <div>
                  <h4 className="font-bold text-gray-900 tracking-tight text-sm">{t.author}</h4>
