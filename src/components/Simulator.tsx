          ...
          <div className="grid lg:grid-cols-12 gap-10 lg:gap-16 items-center relative z-10">
            ...
            <div className="lg:col-span-5">
              ...
              <h3 className="text-2xl md:text-4xl font-bold font-heading mb-4 tracking-tight text-gray-900 leading-tight">
                Transparência desde o <span className="text-gray-600">primeiro</span> minuto.
              </h3>
              ...
              <div className="bg-black/20 p-6 md:p-8 rounded-[1.5rem] border border-white/5 space-y-8 shadow-2xl">
                ...
                <div className="space-y-4">
                  <div className="flex justify-between items-end">
                    <label className="text-gray-600 font-medium text-[10px] md:text-xs uppercase tracking-wider">Quanto precisa?</label>
                ...
                <div className="space-y-4">
                  <div className="flex justify-between items-end">
                    <label className="text-gray-600 font-medium text-[10px] md:text-xs uppercase tracking-wider">Por quanto tempo?</label>
                ...
                <div className="glass-card rounded-[1rem] p-5 border border-gray-200 flex flex-col sm:flex-row gap-5 justify-between sm:items-center mt-4 shadow-xl">
                  <div>
                    <div className="text-[10px] text-gray-600 mb-1 tracking-wider uppercase">Parcela Mensal Estimada</div>
