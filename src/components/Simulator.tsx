    ...
    <section id="simulator" className="relative z-10 scroll-mt-24">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <motion.div 
          ...
          className="glass-panel rounded-[2rem] md:rounded-[2.5rem] p-6 md:p-10 border border-gray-900/10 relative overflow-hidden"
        >
          ...
          <div className="grid lg:grid-cols-12 gap-10 lg:gap-16 items-center relative z-10">
            ...
            <div className="lg:col-span-7">
              <div className="bg-black/20 p-6 md:p-8 rounded-[1.5rem] border border-gray-900/5 space-y-8 shadow-2xl">
                ...
                <div className="space-y-4">
                  ...
                  <div className="h-2 w-full bg-gray-900/5 rounded-full relative overflow-hidden">
                    <div 
                ...
                {/* Results Card */}
                <div className="glass-card rounded-[1rem] p-5 border border-gray-900/10 flex flex-col sm:flex-row gap-5 justify-between sm:items-center mt-4 shadow-xl">
                  <div>
