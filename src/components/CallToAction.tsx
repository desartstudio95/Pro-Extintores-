      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
          ...
          <div className="flex-1 flex flex-col items-center lg:items-start text-center lg:text-left max-w-2xl">
            ...
            <p className="text-white/90 text-xs md:text-sm leading-relaxed font-light md:pl-11 mb-6">
              Solicite uma avaliação gratuita e descubra a melhor solução para o seu negócio.
            </p>
            
            <div className="flex items-center shrink-0 w-full sm:w-auto md:pl-11">
              <a 
          ...
          <div className="w-full lg:w-5/12 flex justify-center lg:justify-end shrink-0 relative mt-8 lg:mt-0 pointer-events-none">
            <img 
