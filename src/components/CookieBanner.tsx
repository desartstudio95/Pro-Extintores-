          ...
          <div className="max-w-5xl mx-auto bg-slate-900 text-white rounded-2xl shadow-2xl p-5 md:p-6 flex flex-col md:flex-row items-center gap-5 md:gap-8 pointer-events-auto border border-slate-800">
            ...
            <div className="flex items-center gap-3 w-full md:w-auto shrink-0 mt-2 md:mt-0">
              ...
              <button
                ...
                className="flex-1 md:flex-none bg-gradient-to-r from-pro-red to-red-700 hover:from-gray-900 hover:to-black hover:shadow-black/40 px-6 py-2.5 rounded-lg font-bold text-sm text-white shadow-lg shadow-pro-red/20 transition-all active:scale-95"
              >
                Aceitar Todos
              </button>
            </div>
