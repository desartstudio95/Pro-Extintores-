...
export default function BenefitBar() {
  return (
    <section className="relative z-20 px-4 md:px-8 max-w-7xl mx-auto w-full -mt-4 md:-mt-10 lg:-mt-16">
      <div className="bg-pro-red rounded-2xl p-6 md:p-8 lg:p-10 shadow-2xl shadow-pro-red/20 border border-gray-300">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
          {benefits.map((benefit, index) => (
            <motion.div 
              ...
              className="flex flex-col items-center text-center sm:items-start sm:text-left gap-4 bg-white/10 p-6 rounded-xl border border-white/20 hover:bg-white/20 transition-colors"
            >
